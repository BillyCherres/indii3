...
```
- Bubble Sort
- Compares every element in a list and swaps them to sort
- Goes through the list multiple times
- Stops when list is completely sorted.
...
* Applies operation to popped values (calculates)
* Stores value and repeats
